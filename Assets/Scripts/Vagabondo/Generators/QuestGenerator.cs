    ...
    public class QuestGenerator
    {
        ...
        private void generateState(QuestState questState, string plotItemId)
        {
            ...
            if (plotItemId == "dungeonIntro")
            {
                ...
                questState.memoryDescription = "A local farmer told you that somewhere in a neighbouring valley lay the ruins an old church, abandoned a century ago after a plague.";
            ...
            else if (plotItemId == "artifactIntro")
            {
                ...
                questState.memoryDescription = "I racconti popolari della zona menzionano un antico artefatto ormai smarrito. l'artefatto e' di pietra verde ricoperta di muschio. secondo alcuni porta bene, secondo altri male.";
                questState.actionResultText = questState.memoryDescription;
            }
